...
function Data() {
  return (
    <div className={clsx(styles.home_data)}>
      <h1 className={clsx(styles.home_title)}>
        Hello, Myself
        <br />
        SATYA SUNDAR DEY
        <svg
      ...
      <h2 className={clsx(styles.home_subtitle)}>
        {" "}
        <TypeAnimation
          sequence={[
            "Web Developer",
          ...
          wrapper="span"
          speed={60}
          className="text-6xl font-bold text-"
          repeat={Infinity}
        />
      </h2>
      <p className={clsx(styles.home_description)}>
