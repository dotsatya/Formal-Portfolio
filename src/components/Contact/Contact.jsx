        ...
        <div className={clsx(styles.contact_content)}>
          ...
          <div className={clsx(styles.contact_info)}>
            ...
            <div className={clsx(styles.contact_card)}>
              ...
              <span className={clsx(styles.contact_card_data)}>+91 9830751252</span>
            ...
            <div className={clsx(styles.contact_card)}>
              ...
              <span className={clsx(styles.contact_card_data)}>satyasundardey4@gmail.com</span>
            ...
            <div className={clsx(styles.contact_card)}>
              ...
              <span className={clsx(styles.contact_card_data)}>satya-sundar-dey</span>
